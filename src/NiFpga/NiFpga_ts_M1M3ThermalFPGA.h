 ...
 */
static const char* const NiFpga_ts_M1M3ThermalFPGA_Signature = "AD4A298590D050C4CD25020DA469D401";
...
typedef enum {
    NiFpga_ts_M1M3ThermalFPGA_TargetToHostFifoU8_CoolantTempRead = 12,
    NiFpga_ts_M1M3ThermalFPGA_TargetToHostFifoU8_FlowMeter1Read = 10,
    NiFpga_ts_M1M3ThermalFPGA_TargetToHostFifoU8_FlowMeter2Read = 8,
...
typedef enum {
    NiFpga_ts_M1M3ThermalFPGA_HostToTargetFifoU8_CoolantTempWrite = 11,
    NiFpga_ts_M1M3ThermalFPGA_HostToTargetFifoU8_FlowMeter1Write = 9,
    NiFpga_ts_M1M3ThermalFPGA_HostToTargetFifoU8_FlowMeter2Write = 7,
    NiFpga_ts_M1M3ThermalFPGA_HostToTargetFifoU8_GlycoolWrite = 5
} NiFpga_ts_M1M3ThermalFPGA_HostToTargetFifoU8;

typedef enum {
    NiFpga_ts_M1M3ThermalFPGA_HostToTargetFifoU16_CommandFIFO = 13,
