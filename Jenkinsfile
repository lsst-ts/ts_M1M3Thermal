...
node {
    ...
    def SAME_CRIO_BRANCH = ["master", "tickets/DM-31838", "tickets/DM-32146", "tickets/DM-32240"]
    def XML_BRANCH = BRANCH in ["master", "tickets/DM-32146", "tickets/DM-32240"] ? BRANCH : "develop"
